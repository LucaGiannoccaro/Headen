...
//create all the item tha are in the local storage
...
//remove one item. local + database (ajax)
...
//move up one item. local + database (ajax)
...
//move down one item. local + database (ajax)
